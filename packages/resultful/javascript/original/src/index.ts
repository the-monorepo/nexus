 ...
 */
export const exception: CreateExceptionFn = <EX>(
	exception: EX,
): ExceptionResult<EX> => {
	return {
...
export type ResultHandlerOption<
	Key extends string | number | symbol,
	T,
	V,
	R,
> = Record<Key, ResultHandler<T, V, R>>;
...
export type FullHandleOptions<P, E, EX, PR, ER, EXR> = HandlePayloadOptions<
	P,
	PR
> &
...
export type OptionsBasedOnResult<
	R extends TypedResultfulSchema,
	PR,
	ER,
	EXR,
> = Partial<FullOptionsBasedOnResult<R, PR, ER, EXR>>;
