...
export type HandleOptions<P, E, PR, ER> = Partial<
	FullHandleOptions<P, E, PR, ER>
>;
...
export type OptionsBasedOnResult<
	...
	PR,
	ER,
> = Partial<FullOptionsBasedOnResult<R, PR, ER>>;
...
export type ValueOf<R extends TypedResultfulSchema> = R extends OkResult<
	infer P
>
	? P
