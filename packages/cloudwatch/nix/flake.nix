{
  ...
  outputs = inputs:
    ...
    in {
      packages = (createDerivation "aarch64-darwin") // (createDerivation "x86_64-darwin") // (createDerivation "aarch64-linux") // (createDerivation "armv6l-linux") // (createDerivation "x86_64-linux");
    };
}