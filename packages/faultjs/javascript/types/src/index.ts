...
export type TestResult = Payload<
	typeof IPC.TEST,
	PassingTestData | FailingTestData
>;
...
export type FileFinishedResult = Payload<
	typeof IPC.TEST_FILE,
	FileFinishedData
>;
...
export type StoppedWorkerResult = Payload<
	typeof IPC.STOPPED_WORKER,
	StoppedWorkerData
>;
...
export type WorkingOnTestResult = Payload<
	typeof IPC.WORKING_ON_TEST,
	WorkingOnTestData
>;
