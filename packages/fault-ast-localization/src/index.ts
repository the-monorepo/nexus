...
import { Statement, BlockStatement, EmptyStatement, VariableDeclaration, VariableDeclarator, isIdentifier, Declarator } from '@babel/types';
...
const localizeVariableDeclarator = async (variableDeclarator: VariableDeclarator, dependencies: Map<string, Set<string>>, assertion: AssertionFailureData) => {
...
const localizeVariableDeclaration = async (variableDeclaration: VariableDeclaration, dependencies: Map<string, Set<string>>, assertion: AssertionFailureData) => {
  for(const declarator of variableDeclaration.declarations) {
    await localizeVariableDeclarator(declarator);
  }
};

const localizeBlockStatement = async (blockStatement: BlockStatement, assertion: AssertionFailureData) => {
