...
const Contact = withStyles(theme => ({
  contact: {
...
const ResumeLink = withStyles(theme => ({
  printLink: {
    display: 'none',
  },
  '@media print': {
...
const Topic = withStyles(theme => ({
  ...
  ({ heading, children, classes, otherClasses = { container: undefined }, ...other }) => (
    <section className={classNames(classes.container, otherClasses.container)}>
      <Typography
        variant="subtitle2"
        color="primary"
        component="h1"
...
const ListLabel = withStyles(theme => ({
  label: {
    fontWeight: theme.typography.fontWeightMedium,
  },
}))(({ children, classes, ...other }) => (
