...
const _template = mbx.elementTemplate("<tr><td class=\"col-md-1\"></td><td class=\"col-md-4\"><a data-action=\"select\"></a></td><td class=\"col-md-1\"><a data-action=\"delete\"><span class=\"glyphicon glyphicon-remove\" aria-hidden=\"true\"></span></a></td><td class=\"col-md-6\"></td></tr>", _rootNode => {
  const _tr$ = _rootNode;
  const _td$ = _tr$.firstChild;
  const _td$2 = _td$.nextSibling;
  const _a$ = _td$2.firstChild;
  return [mbx.attribute(_tr$, "class"), mbx.attribute(_tr$, "id"), mbx.property(_td$, _textContent$setter), mbx.property(_a$, _textContent$setter)];
});
...
const _template2 = mbx.elementTemplate("<div class=\"container\"><div class=\"jumbotron\"><div class=\"row\"><div class=\"col-md-6\"><h1>React + Mobx</h1></div><div class=\"col-md-6\"><div class=\"row\"><div class=\"col-sm-6 smallpad\"><button type=\"button\" class=\"btn btn-primary btn-block\" id=\"run\">Create 1,000 rows</button></div><div class=\"col-sm-6 smallpad\"><button type=\"button\" class=\"btn btn-primary btn-block\" id=\"runlots\">Create 10,000 rows</button></div><div class=\"col-sm-6 smallpad\"><button type=\"button\" class=\"btn btn-primary btn-block\" id=\"add\">Append 1,000 rows</button></div><div class=\"col-sm-6 smallpad\"><button type=\"button\" class=\"btn btn-primary btn-block\" id=\"update\">Update every 10th row</button></div><div class=\"col-sm-6 smallpad\"><button type=\"button\" class=\"btn btn-primary btn-block\" id=\"clear\">Clear</button></div><div class=\"col-sm-6 smallpad\"><button type=\"button\" class=\"btn btn-primary btn-block\" id=\"swaprows\">Swap Rows</button></div></div></div></div></div><table class=\"table table-hover table-striped test-data\"><tbody></tbody></table><span class=\"preloadicon glyphicon glyphicon-remove\" aria-hidden=\"true\"></span></div>", _rootNode2 => {
  ...
  return [mbx.event(_button$, "click"), mbx.event(_button$2, "click"), mbx.event(_button$3, "click"), mbx.event(_button$4, "click"), mbx.event(_button$5, "click"), mbx.event(_button$6, "click"), mbx.event(_tbody$, "click"), mbx.children(_tbody$, null)];
});

const Main = () => mbx.componentResult(_template2, [run, runLots, add, update, clear, swapRows, rowClick, repeat(data, idKeyFn, Row)]);
