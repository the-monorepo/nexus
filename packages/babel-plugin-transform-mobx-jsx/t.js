...
const Row = props => function () {
  ...
  return mbx.dynamicNode(_root$, mbx.fields(_root$, mbx.attribute("class", () => props.data.isSelected ? 'danger' : '')), mbx.children(_marker$, () => props.data.id), mbx.children(_marker$2, () => props.data.label));
}();
...
const Main = () => function () {
  ...
  return mbx.dynamicNode(_root$2, mbx.fields(_button$, mbx.property("onclick", () => client.run)), mbx.fields(_button$2, mbx.property("onclick", () => client.runLots)), mbx.fields(_button$3, mbx.property("onclick", () => client.add)), mbx.fields(_button$4, mbx.property("onclick", () => client.update)), mbx.fields(_button$5, mbx.property("onclick", () => client.clear)), mbx.fields(_button$6, mbx.property("onclick", () => client.swapRows)), mbx.children(_marker$3, () => repeat(store.data, d => function () {
    ...
    return mbx.dynamicNode(_root$3, mbx.subComponent(Row, _root$3, undefined, mbx.dynamicField("data", () => d)));
  }())));
}();
