...
const Row = ({ id, label, selected }) => (
    <tr class={selected ? 'danger' : null} id={id}>
        <td class="col-md-1" $textContent={id}/>
        <td class="col-md-4">
            <a data-action='select' $textContent={label}/>
        </td>
        <td class="col-md-1"><a data-action='delete'><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a></td>
        <td class="col-md-6"/>
    </tr>
);
