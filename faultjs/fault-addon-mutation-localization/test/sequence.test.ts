import { deleteStatementSequence, getAstPath, Instruction, executeInstructions, getTraverseKeys, mutationWrapperToInstruction } from '../src/index';
...
describe('sequences', () => {
  ...
  it ('delete statement', () => {
    ...
    const blockPath = astPath.get('body')[0].get('declarations')[0].get('init').get('body');
